...
const ServicesPage = ({ onNavigate }) => {
    ...
    const mainServices = [
        ...
        },
        {
            ...
            technologies: ["React", "Vue.js", "Flutter", "React Native", "Swift", "Kotlin", "Firebase"],
            timeline: "6-16 weeks",
    ...
    const whyChooseUs = [
        {
            ...
            description: "5+ years of delivering successful projects across various industries"
        },
        {
            ...
            <section className="services-cta-section">
                <div className="services-cta-container">
                    <div className="services-cta-card">
                        ...
                        <div className="services-cta-bg-1"></div>
                        <div className="services-cta-bg-2"></div>
                    </div>
                </div>
            </section>
